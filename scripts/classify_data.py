...
출력 (JSON만):"""
    ...
    def classify_news_data(self, limit: int = 100):
        ...
        # 분류되지 않은 데이터 조회 (category가 NULL 또는 'NEWS')
        url = f"{self.supabase_url}/rest/v1/phishing_news?select=id,title,content&or=(category.is.null,category.eq.NEWS)&limit={limit}"
